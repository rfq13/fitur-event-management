     ...
     <div class="container-fluid">
         ...
         <div class="row d-flex justify-content-center align-items-center h-100 mx-md-5">
             ...
             <div class="col-lg-4 col-xl-5 col-flex mt-lg-0 pt-lg-4 mt-5 pt-5">
                 ...
                 <h1 class="heading font-weight-bold display-3 mb-4">Hai<span>,</span> <br class="d-block d-md-none d-lg-block d-xl-none">Yuk jadi siswa <br>Berprestasi :D</span></h1>
                 ...
                 <div class="mr-auto">
                     <button type="button" class="btn purple-gradient btn-rounded ml-0">Get in touch</button>
                 </div>
