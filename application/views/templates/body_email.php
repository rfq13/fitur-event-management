                                ...
                                <tr height="70" style="height:70px;">
                                    <td align="center">
                                        <a href="" style="display: block; border-style: none !important; border: 0 !important;">
                                            <img width="140" border="0" style="display: block; width: 140px;" src="https://i2.wp.com/lenterakecil.com/wp-content/uploads/2012/06/UKS-1.jpg?w=500&ssl=1" alt="" />
                                        </a>
                                    </td>
                                    <td align="center">
                                        <a href="" style="display: block; border-style: none !important; border: 0 !important;">
                                            <img width="65" border="0" style="display: block; width: 65px;" src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/ba/City_of_Surabaya_Logo.svg/1200px-City_of_Surabaya_Logo.svg.png" alt="" />
                                        </a>
                                    </td>
                                </tr>
                            </table>
        ...
        <tr>
            <td align="center">
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
                            ...
                            <div style="line-height: 35px">
                                ...
                                EVENT <span style="color: #66d25c;">UKS</span> DISPENDIK KOTA SURABAYA
                                ...
                                <tr>
                                    <td align="center" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px">
                                            Hi Dokter cilik! UKS Dinas Pendidikan kota Surabaya ada event baru lo!!, yaitu <a href="<?= $detail; ?>" style="color: #66d25c;"><?= strtoupper($event); ?></a>.
                                        </div>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td align="center">
                            <table border="0" align="center" width="160" cellpadding="0" cellspacing="0" bgcolor="66d25c" style="border-radius: 2px 70px 2px 70px;">
                                ...
                                <tr>
                                    <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;">
                                        ...
                                        <div style="line-height: 26px;">
                                            ...
                                            <a href="<?= $link; ?>" style="color: #ffffff; text-decoration: none;">Yuk
                                                Ikutan!</a>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;" class="text_color">
                                        <div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                            ...
                                            Email : <br /> <a href="mailto:uks.dispendik@gmail.com" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">uks.dispendik@gmail.com</a>
                    ...
                    <tr>
                        <td>
                            <table border="0" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="container590">
                                <tr>
                                    <td style="color: #aaaaaa; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px;">
                                            <span><a style="color: #343434; font-size: 14px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 2px;" href='<?= $home; ?>'>EVENT <span style="color: #66d25c;">UKS</span>DISPENDIK SBY</a></span>
                                        </div>
                                    </td>
                                </tr>
                            </table>
